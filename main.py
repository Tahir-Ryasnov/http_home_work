...
#В чате задавал вопрос там ответили проверили код, нашли ошибку. Ошибку исправил но у меня выдаёт всю ту же ошибку. 
#Человек, который мне помогал, говорит что у него этот код работает как с его токеном так и с моим. И я увидел что на Яндекс Диске появился файл. Но когда делаю сам выдаёт ошибку...
